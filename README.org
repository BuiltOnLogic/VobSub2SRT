...
- Arch Linux
- Fedora 34-40 (Fedora 39 requires cmake downgrade to 3.27 if using 3.30)
- Debian 9-14
...
#+BEGIN_EXAMPLE
  sudo apt-get install libtesseract-dev libtiff-dev tesseract-ocr-eng build-essential cmake pkg-config
#+END_EXAMPLE
...
For Debian you need the following extra packages:
...
If a subtitle file contains more than one language you can use the =--tesseract-lang=
