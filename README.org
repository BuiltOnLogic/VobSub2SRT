...
Minimum:
Debian GNU/Linux 5.0.10 "Squeeze", kernel 2.6.32-5-amd64, GCC 4.4.5, CMake 2.8.2,
libtiff4-3.9.45squeeze10, libjpeg62-dev 6b1-1, tesseract-ocr-dev 2.04.2 libleptonica-dev 1.62.1.1+b1

Current:
Arch Linux, kernel 6.19-rc7 (amd64, custom tuning), GCC 15.2.1, CMake 4.2.3, libtiff 4.7.1-1,
libjpeg-turbo 3.1.3.1 tesseract-data-eng 2.4.1.0-4 tesseract 5.5.2.1 leptonica 1.87.0-1
...
This fork is currently maintained by Christopher Ogloff at
