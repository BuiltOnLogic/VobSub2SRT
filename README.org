...
Updated 2026-02-18 by Christopher Ogloff
...
*modern*: CMake version 4.0 drops support for cmake_minimum_required 3.5 or lower.
          I have tested this with CMake 4.2.3, and it builds regardless.
...
#+BEGIN_EXAMPLE
  sudo apt-get install tesseract-ocr-dev libtiff-dev tesseract-ocr-eng build-essential cmake pkg-config libleptonica-dev
#+END_EXAMPLE
...
* Known Issues
May return subtitles with timestamps but no text. Under investigation. (2026-02-18)
...
This fork is currently maintained at
[[https://github.com/BuiltOnLogic/]] as of February 18, 2026.
